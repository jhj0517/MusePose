...
class MusePoseInference:
    def __init__(self,
        ...
        self.models_paths = {
            ...
            "motion_module": config["motion_module_path"],
    ...
    def infer_musepose(
        ...
        output_path = os.path.abspath(os.path.join(self.output_dir, f'{dt_file_name}.mp4'))
        output_path_demo = os.path.abspath(os.path.join(self.output_dir, f'{dt_file_name}_demo.mp4'))
        ...
        self.image_enc = CLIPVisionModelWithProjection.from_pretrained(
            self.models_paths["image_encoder"]
        ).to(dtype=weight_dtype, device="cuda")
